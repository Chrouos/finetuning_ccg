...
from utils.cor_model import generate_text as local_generate_text
from utils.cor_model import initialize_bnb_config, load_model, merge_models, load_tokenizer
from utils.cor_model import llama_generate_text
from transformers import LlamaForCausalLM, PreTrainedTokenizerFast
load_dotenv()

class GenerateResponseLLAMA:
    
    def __init__(self, model_folder="model/", fine_tuned_model_path="final_output/", model_name="" ) -> None:
    ...
    def generate_text(self, prompt, max_length=128000):
...
class GenerateResponseGPT:
    ...
    def __init__(self, openai_key="GPT_KEY") -> None:
    ...
    def generate_text(self, prompt, model_name="gpt-4o-mini"):
...
# class GeneratorResponse:
    ...
    def by_local_model_generate_text(self, prompt):
        ...
        try:
            generated_text = local_generate_text(self.model, self.tokenizer, prompt)
        except:
            generated_text = {}
